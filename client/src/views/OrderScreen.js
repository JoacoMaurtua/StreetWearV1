...
const OrderScreen = () => {
  ...
  useEffect(() => {
    ...
    if (!order || successPay || successDeliver) {
      //si no existe la orden o si ya ha sido pagada o si ya ha sido entregada
  ...
  }, [dispatch, history, order, id, successPay, successDeliver, userInfo]);

  const successPaymentHandler = (paymentResult) => {
    //paymentresult viene de paylpal
