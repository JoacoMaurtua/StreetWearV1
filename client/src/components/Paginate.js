        ...
        {[...Array(pages).keys()].map((x) => (
          ...
          <LinkContainer   /*Aqui esta el pedazo de codigo que probablemente contenga el error */
                ...
                to={
                    !isAdmin
                      ? keyword 
                        ? `/search/${keyword}/page/${x + 1}` //Se distorciona el renderizado tanto con keyword como con keyword2
                              
                          : keyword && keyword2
                          ? `/search/${keyword}/${keyword2}/page/${x + 1}` // sospecho que estas rutas no estan funcionando bien
